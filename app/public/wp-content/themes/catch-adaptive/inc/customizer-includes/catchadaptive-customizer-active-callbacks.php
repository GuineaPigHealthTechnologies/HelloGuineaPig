...
if ( ! function_exists( 'catchadaptive_is_slider_active' ) ) :
	/**
	* Return true if slider is active
	*
	* @since  Catch Adaptive 1.2
	*/
	function catchadaptive_is_slider_active( $control ) {
		global $wp_query;
		...
		$enable = $control->manager->get_setting( 'catchadaptive_theme_options[featured_slider_option]' )->value();
...
if ( ! function_exists( 'catchadaptive_is_demo_slider_inactive' ) ) :
	/**
	* Return true if demo slider is inactive
	*
	* @since  Catch Adaptive 1.2
	*/
	function catchadaptive_is_demo_slider_inactive( $control ) {
		global $wp_query;
		...
		$type 	= $control->manager->get_setting( 'catchadaptive_theme_options[featured_slider_type]' )->value();
...
if ( ! function_exists( 'catchadaptive_is_featured_content_active' ) ) :
	/**
	* Return true if featured content is active
	*
	* @since  Catch Adaptive 1.2
	*/
	function catchadaptive_is_featured_content_active( $control ) {
		global $wp_query;
		...
		$enable = $control->manager->get_setting( 'catchadaptive_theme_options[featured_content_option]' )->value();
...
if ( ! function_exists( 'catchadaptive_is_demo_featured_content_inactive' ) ) :
	/**
	* Return true if demo featured content is inactive
	*
	* @since  Catch Adaptive 1.2
	*/
	function catchadaptive_is_demo_featured_content_inactive( $control ) {
		global $wp_query;
		...
		$type 	= $control->manager->get_setting( 'catchadaptive_theme_options[featured_content_type]' )->value();
